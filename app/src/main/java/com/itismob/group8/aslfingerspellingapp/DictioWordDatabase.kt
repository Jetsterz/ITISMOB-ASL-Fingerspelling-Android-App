...
class DictioWordDatabase(c: Context) {
    ...
    fun addWord (w: Word) : Int {
        ...
        val _id = db.insert(WordDBHandler.DICTIO_WORDS_TABLE, null, cv)
        return _id.toInt()
    }
    ...
    fun updateWord (w: Word) {
        ...
        db.update(WordDBHandler.DICTIO_WORDS_TABLE, cv, where, args)
    }
    ...
    fun deleteWord (w: Word) {
        ...
        db.delete(WordDBHandler.DICTIO_WORDS_TABLE, where, args)
    }
    ...
    fun getAllWords() : ArrayList<Word> {
        ...
        val c : Cursor = db.query(
            WordDBHandler.DICTIO_WORDS_TABLE,
            null,
            null,
            null,
            null,
