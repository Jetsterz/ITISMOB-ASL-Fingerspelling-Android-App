...
import com.itismob.group8.aslfingerspellingapp.databinding.PracticeItemGestureRecognizerResultBinding
import java.util.Locale
import kotlin.math.min

class PracticeGestureRecognizerResultsAdapter:
    RecyclerView.Adapter<PracticeGestureRecognizerResultsAdapter.ViewHolder>() {
        companion object {
        ...
        override fun onCreateViewHolder(
            ...
            val binding = PracticeItemGestureRecognizerResultBinding.inflate(
        ...
        inner class ViewHolder(private val binding: PracticeItemGestureRecognizerResultBinding) :
